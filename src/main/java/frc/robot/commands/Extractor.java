 ...
 */
public class Extractor extends Command {
  public Extractor() {
    // Use requires() here to declare subsystem dependencies
    requires(Robot.extract);
  }
  ...
  protected void execute() {
    double extractSpeed = deadband(Robot.m_oi.opController.getRawAxis(RobotMap.OP_JOYSTICK_MOVE_RIGHT_AXIS),.1); 
    Robot.extract.extractMove(extractSpeed);
  }
